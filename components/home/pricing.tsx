...
export default function Pricing(): JSX.Element {
    return (
        ...
        >
            {/* Header */}
            <div className="mx-auto mb-16 max-w-4xl text-center relative">
...
function PricingCard({
    ...
    return (
        <div
            className={`relative flex flex-col rounded-2xl p-8 ${highlighted
        ...
        >
            ...
            <ul className="mb-8 space-y-3 text-sm text-gray-300 grow">
